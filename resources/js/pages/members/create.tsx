                                                ...
                                                {data.family_members.map((member, index) => (
                                                        <div key={index} className="grid grid-cols-1 lg:grid-cols-3 gap-x-3 gap-y-4">
                                                                <div className="flex flex-col gap-2">
                                                                        ...
                                                                        <Input type="text" name="first_name" placeholder='npr. Osman' onChange={(e) => changeFamilyMember(e.target.name as keyof FamilyMember, e.target.value, index)} value={member.first_name || ''} />
                                                                </div>
                                                                ...
                                                                <div className="flex flex-col gap-2">
                                                                        ...
                                                                        <Input type="text" name="last_name" placeholder='npr. Ljubinac' onChange={(e) => changeFamilyMember(e.target.name as keyof FamilyMember, e.target.value, index)} value={member.last_name || ''} />
                                                                </div>
                                                                <div className="flex flex-col gap-2">
                                                                        <Label>Odnos</Label>
                                                                        <Select
                                                                ...
                                                                <div className="flex flex-col gap-2">
                                                                        ...
                                                                        <Input type="text" name="email" placeholder='npr. osman.ljubinac@gmail.com' onChange={(e) => changeFamilyMember(e.target.name as keyof FamilyMember, e.target.value, index)} value={member.email || ''} />
                                                                </div>
                                                                ...
                                                                <div className="flex flex-col gap-2">
                                                                        ...
                                                                        <Input type="text" name="phone" placeholder='npr. +387 61 123 456' onChange={(e) => changeFamilyMember(e.target.name as keyof FamilyMember, e.target.value, index)} value={member.phone || ''} />
                                                                </div>
                                                                <div className="flex flex-col gap-2">
                                                                        <Label htmlFor='address'>
                                                                                Adresa
                                                                        </Label>
                                                                        <Input type="text" name="address" placeholder='npr. Gornja mahala 54' onChange={(e) => changeFamilyMember(e.target.name as keyof FamilyMember, e.target.value, index)} value={member.address || ''} />
                                                                </div>
                                                        </div>
                                                ))}
                                        </div>
