...
export default function AdminTicketShow({ ticket, messages }: { ticket: Ticket; messages: Message[] }) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('admin.tickets.reply', { ticket: ticket.id }), {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: ticket.subject, href: `/admin/tickets/${ticket.id}` },
    ];
                    ...
                    <CardContent className="space-y-3">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-3">
                            ...
                            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                                ...
                                <Button type="submit" variant="secondary" className="w-full sm:w-auto" disabled={processing}>
                                    Pošalji odgovor
                                </Button>
                            </div>
                        </form>
